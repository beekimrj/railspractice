...
ActiveRecord::Schema.define(version: 2020_02_05_040746) do
  ...
  create_table "paragraphs", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title"
    t.text "body"
    ...
    t.index ["hotel_id"], name: "index_paragraphs_on_hotel_id"
  end

  add_foreign_key "paragraphs", "articles"
  add_foreign_key "paragraphs", "hotels"
end
